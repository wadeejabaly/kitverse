import { z } from "zod";
import { DELIVERY_REGIONS, SIZES, VERSIONS } from "@/data/pricing";
...
const DeliveryRegionSchema = z.custom<DeliveryRegion>(
  (value) => typeof value === "string" && (DELIVERY_REGIONS as string[]).includes(value),
);
