 ...
 * which the cart page does not collect (that happens at checkout). Showing a
 * number here would either lie for most shoppers or force a region choice
 * before they have even started filling in an address.
 */
